...
samples2 = loadMCSamples('../../../NGC4258-LMC-MW-R16/hypermcmc/output/chains/previous_runs/fit_52/mcmc_final_output_HP',settings={'ignore_rows': 0. }) 
...
if number_of_parameters == 26 :
    ...
    g.triangle_plot([samples,samples2],['mu04258','muLMC','Mw','Zw','bw','H0'],filled_compare=True,legend_labels=['R11 data set','R16 data set'],line_args=[{'ls':'dotted','color':'red'},{'lw':2,'color':'blue'}],contour_colors=['red','blue'],legend_loc='upper right')
    ...
    g.export('triangle_plot_fit_29_43.pdf')
