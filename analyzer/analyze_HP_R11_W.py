...
number_of_parameters = 25 # 14 NGC4258 AS ANCHOR, 16 LMC AS ANCHOR, 17 MW AS ANCHOR, 16 NGC4258+LMC AS ANCHORS, 15 NGC4258+MW AS ANCHORS, 
# 16 LMC+MW AS ANCHORS, 16 NGC4258+LMC+MW AS ANCHORS, 25 MW AS ANCHOR WITH VARYING SIGMA INT
...
if number_of_parameters == 24:
    ...
    g.triangle_plot(samples,['mu04258','Mw','Zw','bw','H0'],filled=True)
