Module fiducial
    ...
    ! 27 FOR ALL R11 CEPHEIDS + NGC4258, LMC AND MW AS ANCHORS AND SIGMA INT PER HOST GALAXY, 26 FOR ALL R11 CEPHEIDS + NGC4258, LMC AND MW AS ANCHORS AND SIGMA INT PER HOST GALAXY SETTING METALLICITY TO ZERO
