Module fiducial
    ...
    Integer*4,parameter :: number_model_parameters = 25 ! NUMBER OF PARAMETERS IN MODEL : 3 FOR MW ALONE, 10 FOR R11 DATA WITHOUT METALLICITY,
    ...
    ! 16 FOR ALL R11 CEPHEIDS + MW AND LMC AS ANCHORS, 16 FOR ALL R11 CEPHEIDS + NGC4258, LMC AND MW AS ANCHORS, 25 FOR ALL R11 CEPHEIDS +
    ...
    Logical,parameter   :: doing_R11_analysis = .true.  ! DO R11 ANALYSIS IF SET IT TRUE, OTHERWISE DO EFSTATHIOU'S SECTION 2 (LMC CEPHEIDS ALONE) OR FIT MW CEPHEIDS
    Logical,parameter   :: fit_MW_cepheids_alone = .false.               ! FIT MW CEPHEIDS ALONE IF SET IT TRUE
