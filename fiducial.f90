Module fiducial
    ...
    Integer*4,parameter :: number_model_parameters = 4 ! NUMBER OF PARAMETERS IN MODEL : 3 FOR MW ALONE, 10 FOR R11 DATA WITHOUT METALLICITY,
    ...
    Logical,parameter   :: doing_R11_analysis = .false.  ! DO R11 ANALYSIS IF SET IT TRUE, OTHERWISE DO EFSTATHIOU'S SECTION 2 (LMC CEPHEIDS ALONE) OR FIT MW CEPHEIDS
