Module fiducial
    ...
    Real*8,parameter    :: prior_sigma_int = 0.3d0!0.20d0 SN Ia hosts
    ...
    Integer*4,parameter :: number_model_parameters = 4 ! NUMBER OF PARAMETERS IN MODEL : 2 FOR LMC ALONE, 10 FOR R11 DATA WITHOUT METALLICITY,
