                      ...
                      Else
                         ...
                         If (sigma_int_per_R11_host) then
                            ...
                            If (include_all_R11_hosts) then
                               ...
                               old_point(17) = log10(prior_sigma_int_MW) ! log10(sigma_int_MW)

                               old_point(18) = log10(prior_sigma_int) ! log10(sigma_int_R11)

                               old_point(19) = log10(prior_sigma_int) ! log10(sigma_int_R11)

                               old_point(20) = log10(prior_sigma_int) ! log10(sigma_int_R11)

                               old_point(21) = log10(prior_sigma_int) ! log10(sigma_int_R11)

                               old_point(22) = log10(prior_sigma_int) ! log10(sigma_int_R11)

                               old_point(23) = log10(prior_sigma_int) ! log10(sigma_int_R11)

                               old_point(24) = log10(prior_sigma_int) ! log10(sigma_int_R11)

                               old_point(25) = log10(prior_sigma_int) ! log10(sigma_int_R11)

                               old_point(26) = log10(prior_sigma_int) ! log10(sigma_int_R11)

                               old_point(27) = log10(prior_sigma_int) ! log10(sigma_int_R11)

                            Else

                               old_point(1) = prior_mu3 

                               old_point(2) = prior_mu4

                               old_point(3) = prior_mu5

                               old_point(4) = prior_mu9

                               old_point(5) = prior_mu10

                               old_point(6) = prior_Mw

                               old_point(7) = prior_bw

                               old_point(8) = prior_H0

                               old_point(9) = prior_Zw

                               old_point(10) = a_v

                               old_point(11) = a_cal

                               old_point(12) = log10(prior_sigma_int_MW) ! log10(sigma_int_MW)

                               old_point(13) = log10(prior_sigma_int) ! log10(sigma_int_R11)

                               old_point(14) = log10(prior_sigma_int) ! log10(sigma_int_R11)

                               old_point(15) = log10(prior_sigma_int) ! log10(sigma_int_R11)

                               old_point(16) = log10(prior_sigma_int) ! log10(sigma_int_R11)

                               old_point(17) = log10(prior_sigma_int) ! log10(sigma_int_R11)
                         ...
                         Else
                            ...
                            If (varying_sigma_int) then
                               ...
                               old_point(16) = log10(prior_sigma_int_MW) ! log10(sigma_int_MW)
                      ...
                      Else
                         ...
                         If (sigma_int_per_R11_host) then
                            ...
                            Else
                               ...
                               x_old(1) = genunf(real(prior_mu3 - sigma_mu3),real(prior_mu3 + sigma_mu3))

                               x_old(2) = genunf(real(prior_mu4 - sigma_mu4),real(prior_mu4 + sigma_mu4))

                               x_old(3) = genunf(real(prior_mu5 - sigma_mu5),real(prior_mu5 + sigma_mu5))

                               x_old(4) = genunf(real(prior_mu9 - sigma_mu9),real(prior_mu9 + sigma_mu9))

                               x_old(5) = genunf(real(prior_mu10 - sigma_mu10),real(prior_mu10 + sigma_mu10))

                               x_old(6) = genunf(real(prior_Mw - sigma_Mw),real(prior_Mw + sigma_Mw))

                               x_old(7) = genunf(real(prior_bw - sigma_bw),real(prior_bw + sigma_bw))

                               x_old(8) = genunf(real(prior_H0 - sigma_H0),real(prior_H0 + sigma_H0))

                               x_old(9) = genunf(real(prior_Zw - sigma_Zw),real(prior_Zw + sigma_Zw))

                               x_old(10) = genunf(real(a_v - sigma_a_v),real(a_v + sigma_a_v))

                               x_old(11) = genunf(real(a_cal - sigma_a_cal),real(a_cal + sigma_a_cal))

                               x_old(12) = genunf(real(-3.d0),real(-0.7d0))

                               x_old(13) = genunf(real(-3.d0),real(-0.7d0))

                               x_old(14) = genunf(real(-3.d0),real(-0.7d0))

                               x_old(15) = genunf(real(-3.d0),real(-0.7d0))
                         ...
                         Else
                            ...
                            Else
                               ...
                               print *,'IMPLEMENT NO VARYING SIGMA INT '
                      ...
                      Else
                         ...
                         If (sigma_int_per_R11_host) then
                            ...
                            If (include_all_R11_hosts) then
                               ...
                               old_point(27) = 10**(old_point(27))

                               old_loglikelihood = log_R11_likelihood_W_MW_sigma_int(old_point(1:number_model_parameters-17),&
                                    old_point(number_model_parameters-16),old_point(number_model_parameters-15),&
                                    old_point(number_model_parameters-14),old_point(number_model_parameters-13),&
                                    old_point(number_model_parameters-12),old_point(number_model_parameters-11),&
                                    old_point(18:number_model_parameters),old_point(17))
                               ...
                               old_point(27) = log10(old_point(27))

                            Else

                               old_point(12) = 10**(old_point(12))

                               old_point(13) = 10**(old_point(13))

                               old_point(14) = 10**(old_point(14))
                               ...
                               old_loglikelihood = log_R11_likelihood_W_MW_sigma_int_bw(old_point(1:number_model_parameters-12),&
                                    old_point(number_model_parameters-11),old_point(number_model_parameters-10),&
                                    old_point(number_model_parameters-9),old_point(number_model_parameters-8),&
                                    old_point(number_model_parameters-7),old_point(number_model_parameters-6),&
                                    old_point(13:number_model_parameters),old_point(12))

                               old_point(12) = log10(old_point(12))

                               old_point(13) = log10(old_point(13))

                               old_point(14) = log10(old_point(14))
                         ...
                         Else
                            ...
                            If (varying_sigma_int) then
                               ...
                               old_loglikelihood = log_R11_likelihood_W_MW(old_point(1:number_model_parameters-8),&
                                    old_point(number_model_parameters-7),old_point(number_model_parameters-6),&
                                    old_point(number_model_parameters-5),old_point(number_model_parameters-4),&
                                    old_point(number_model_parameters-3),old_point(number_model_parameters-2),&
                            ...
                            Else
                               ...
                               print *, 'NO VARYING SIGMA INT MUST BE IMPLEMENTED'
                   ...
                   Else
                      ...
                      If (sigma_int_per_R11_host) then
                         ...
                         If (include_all_R11_hosts) then
                            ...
                            paramnames(27) = 'log10sigma_int_LMC'
                            latexname(27) = '\log_{10}\sigma_{int}^{LMC}'
                         ...
                         Else
                            ...
                            paramnames(4) = 'mu04258'
                            latexname(4) = '\mu_{0,4258}'

                            paramnames(5) = 'muLMC'
                            latexname(5) = '\mu_{0,LMC}'
                            ...
                            paramnames(12) = 'log10sigma_int_MW'
                            latexname(12) = '\log_{10}\sigma_{int}^{MW}'

                            paramnames(13) = 'log10sigma_int_3'
                            latexname(13) = '\log_{10}\sigma_{int,3}'

                            paramnames(14) = 'log10sigma_int_4'
                            latexname(14) = '\log_{10}\sigma_{int,4}'

                            paramnames(15) = 'log10sigma_int_5'
                            latexname(15) = '\log_{10}\sigma_{int,5}'

                            paramnames(16) = 'log10sigma_int_9'
                            latexname(16) = '\log_{10}\sigma_{int,9}'
                      ...
                      Else
                         ...
                         If (varying_sigma_int) then
                            ...
                            paramnames(16) = 'log10sigma_int_MW'
                            latexname(16) = '\log_{10}\sigma_{int}^{MW}'

                            paramnames(17) = 'log10sigma_int_R11'
                            latexname(17) = '\log_{10}\sigma_{int}^{R11}'
                   ...
                   Else
                      ...
                      If (sigma_int_per_R11_host) then
                         ...
                         If (include_all_R11_hosts) then
                            ...
                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(11))//'   -7.    7.'

                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(12))//'    -3.5    -2.5'

                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(13))//'    55.    105.'
                            ...
                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(27))//'    -3.    -0.7'
                         ...
                         Else
                            ...
                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(4))//'    20.    30.'

                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(5))//'    0.    40.'

                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(6))//'   -7.    7.'

                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(7))//'    -3.5    -2.5'

                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(8))//'    55.    105.'

                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(9))//'    -2.    1.'

                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(10))//'    0.    1.'

                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(11))//'    -1.    1.'

                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(12))//'    -3.    -0.7'

                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(13))//'    -3.    -0.7'

                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(14))//'    -3.    -0.7'
                      ...
                      Else
                         ...
                         If (varying_sigma_int) then
                            ...
                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(10))//'   -7.    0.'

                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(11))//'    -3.5    -2.5'

                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(12))//'    55.    105.'
                         ...
                         Else
                            ...
                            print *,'NO VARYING SIGMA INT NEEDS TO BE IMPLEMENTED'
                   ...
                   Else
                      ...
                      If (sigma_int_per_R11_host) then
                         ...
                         If (include_all_R11_hosts) then
                            ...
                            plausibility(11) = (x_new(11) .le. real(-7.d0)) .or. (x_new(11) .ge. real(7.d0))

                            plausibility(12) =  (x_new(12) .le. real(-3.5d0)) .or. (x_new(12) .ge. real(-2.5d0)) 

                            plausibility(13) =  (x_new(13) .le. real(55.d0)) .or. (x_new(13) .ge. real(105.d0)) 
                            ...
                            plausibility(27) =  (x_new(27) .le. real(-3.d0)) .or. (x_new(27) .ge. real(-0.7d0)) 
                         ...
                         Else
                            ...
                            plausibility(4) = (x_new(4) .le. real(20.d0)) .or. (x_new(4) .ge. real(30.d0))

                            plausibility(5) = (x_new(5) .le. real(0.d0)) .or. (x_new(5) .ge. real(40.d0))

                            plausibility(6) = (x_new(6) .le. real(-7.d0)) .or. (x_new(6) .ge. real(7.d0))

                            plausibility(7) =  (x_new(7) .le. real(-3.5d0)) .or. (x_new(7) .ge. real(-2.5d0)) 

                            plausibility(8) =  (x_new(8) .le. real(55.d0)) .or. (x_new(8) .ge. real(105.d0)) 

                            plausibility(9) =  (x_new(9) .le. real(-2.d0)) .or. (x_new(9) .ge. real(1.d0)) 

                            plausibility(10) =  (x_new(10) .le. real(0.d0)) .or. (x_new(10) .ge. real(1.d0)) 

                            plausibility(11) =  (x_new(11) .le. real(-1.d0)) .or. (x_new(11) .ge. real(1.d0)) 

                            plausibility(12) =  (x_new(12) .le. real(-3.d0)) .or. (x_new(12) .ge. real(-0.7d0)) 

                            plausibility(13) =  (x_new(13) .le. real(-3.d0)) .or. (x_new(13) .ge. real(-0.7d0)) 

                            plausibility(14) =  (x_new(14) .le. real(-3.d0)) .or. (x_new(14) .ge. real(-0.7d0)) 

                            plausibility(15) =  (x_new(15) .le. real(-3.d0)) .or. (x_new(15) .ge. real(-0.7d0)) 
                      ...
                      Else
                         ...
                         If (varying_sigma_int) then
                            ...
                            plausibility(10) = (x_new(10) .le. real(-7.d0)) .or. (x_new(10) .ge. real(0.d0))

                            plausibility(11) =  (x_new(11) .le. real(-3.5d0)) .or. (x_new(11) .ge. real(-2.5d0)) 

                            plausibility(12) =  (x_new(12) .le. real(55.d0)) .or. (x_new(12) .ge. real(105.d0)) 
                            ...
                            Else
                               ...
                               If (sigma_int_per_R11_host) then
                                  ...
                                  If (include_all_R11_hosts) then
                                     ...
                                     current_point(27) = 10**(current_point(27))

                                     current_loglikelihood = log_R11_likelihood_W_MW_sigma_int(&
                                          current_point(1:number_model_parameters-17),&
                                          current_point(number_model_parameters-16),current_point(number_model_parameters-15),&
                                          current_point(number_model_parameters-14),current_point(number_model_parameters-13),&
                                          current_point(number_model_parameters-12),current_point(number_model_parameters-11),&
                                          current_point(18:number_model_parameters),current_point(17))
                                     ...
                                     current_point(27) = log10(current_point(27))

                                  Else

                                     current_point(12) = 10**(current_point(12))

                                     current_point(13) = 10**(current_point(13))

                                     current_point(14) = 10**(current_point(14))
                                     ...
                                     current_loglikelihood = log_R11_likelihood_W_MW_sigma_int_bw(&
                                          current_point(1:number_model_parameters-12),&
                                          current_point(number_model_parameters-11),current_point(number_model_parameters-10),&
                                          current_point(number_model_parameters-9),current_point(number_model_parameters-8),&
                                          current_point(number_model_parameters-7),current_point(number_model_parameters-6),&
                                          current_point(13:number_model_parameters),current_point(12))

                                     current_point(12) = log10(current_point(12))

                                     current_point(13) = log10(current_point(13))

                                     current_point(14) = log10(current_point(14))

                                     current_point(15) = log10(current_point(15))
                               ...
                               Else
                                  ...
                                  If (varying_sigma_int) then
                                     ...
                                     current_loglikelihood = log_R11_likelihood_W_MW(current_point(1:number_model_parameters-8),&
                                          current_point(number_model_parameters-7),current_point(number_model_parameters-6),&
                                          current_point(number_model_parameters-5),current_point(number_model_parameters-4),&
                                          current_point(number_model_parameters-3),current_point(number_model_parameters-2),&
                                          current_point(17),current_point(16))
              ...
              Else If ( ( .not.use_NGC4258_as_anchor .and. .not.use_LMC_as_anchor ) .and. use_MW_as_anchor ) then
                 ...
                 If (use_HP_in_SNIa) then
                    ...
                    Else
                       ...
                       write(UNIT_EXE_FILE,*) 'NEED TO IMPLEMENT COMPUTATION OF SN Ia HPs WHEN NO INCLUDING ALL R11 SN Ia HOSTS'
                 ...
                 If (include_all_R11_hosts) then
                       ...
                       Do n=1,number_of_hosts_galaxies
                          ...
                          If (host(n) .eq. Field(m)) then
                             ...
                             If (PeriodR11(m) .lt. cepheid_Period_limit) then
                                ...
                                If ( chi2R11_W_E14(bestfit(n),bestfit(11),bestfit(12),bestfit(14),10**(bestfit(17+n)),m)&
                                     .le. 1.d0 ) then
                    ...
                    Do m=1,size(Name)
                       ...
                       If (Period(m) .lt. cepheid_Period_limit) then
                          ...
                          If ( chi2R11_W_LMC_E14(bestfit(10),bestfit(11),bestfit(12),bestfit(14),10**(bestfit(27)),m)&
                               .le. 1.d0 ) then
                          ...
                          Else
                             ...
                             write(UNIT_HP_FILE,*) Period(m), observed_m_W(H(m),V(m)-II(m)) - &
                                  ...
                                  bestfit(12),bestfit(14),10**(bestfit(27)),m), 'LMC'
                    ...
                    If (use_HP_in_anchor) then
                       ...
                       Do m=1,size(FieldHipp)
                          ...
                          If (10**(logP(m)) .lt. cepheid_Period_limit) then
                             ...
                             If ( chi2R11_W_MW(bestfit(11),bestfit(12),bestfit(14),10**(bestfit(17)),m) .le. 1.d0) then
                             ...
                             Else
                                ...
                                write(UNIT_HP_FILE,*) 10**(logP(m)), Mw(m) - &
                                     ...
                                     bestfit(12),bestfit(14),10**(bestfit(17)),m), 'MW'
                 ...
                 Else
                    ...
                    write(UNIT_EXE_FILE,*) 'NEED TO IMPLEMENT COMPUTATION OF CEPHEID VARIABLES HPs '

                    write(UNIT_EXE_FILE,*) 'WHEN NO INCLUDING ALL R11 SN Ia HOSTS'
