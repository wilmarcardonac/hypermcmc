                   ...
                   If (use_metallicity) then 
                      ...
                      Else
                         ...
                         If (sigma_int_per_R11_host) then
                            ...
                            old_point(17) = log10(prior_sigma_int_LMC) ! log10(sigma_int_LMC) 
                   ...
                   If (use_metallicity) then 
                      ...
                      Else
                         ...
                         If (sigma_int_per_R11_host) then
                            ...
                            x_old(17) = genunf(real(-3.d0),real(-0.7d0)) ! log10(sigma_int_LMC)

                            x_old(18) = genunf(real(-3.d0),real(-0.7d0)) ! log10(sigma_int_R11)

                            x_old(19) = genunf(real(-3.d0),real(-0.7d0)) ! log10(sigma_int_R11)

                            x_old(20) = genunf(real(-3.d0),real(-0.7d0)) ! log10(sigma_int_R11)

                            x_old(21) = genunf(real(-3.d0),real(-0.7d0)) ! log10(sigma_int_R11)

                            x_old(22) = genunf(real(-3.d0),real(-0.7d0)) ! log10(sigma_int_R11)

                            x_old(23) = genunf(real(-3.d0),real(-0.7d0)) ! log10(sigma_int_R11)

                            x_old(24) = genunf(real(-3.d0),real(-0.7d0)) ! log10(sigma_int_R11)

                            x_old(25) = genunf(real(-3.d0),real(-0.7d0)) ! log10(sigma_int_R11)

                            x_old(26) = genunf(real(-3.d0),real(-0.7d0)) ! log10(sigma_int_R11)
                   ...
                   If (use_metallicity) then 
                      ...
                      Else
                         ...
                         If (sigma_int_per_R11_host) then
                            ...
                            old_point(17) = 10**(old_point(17))   ! sigma_int_LMC

                            old_point(18) = 10**(old_point(18))   ! sigma_int_R11

                            old_point(19) = 10**(old_point(19))   ! sigma_int_R11

                            old_point(20) = 10**(old_point(20))   ! sigma_int_R11

                            old_point(21) = 10**(old_point(21))   ! sigma_int_R11

                            old_point(22) = 10**(old_point(22))   ! sigma_int_R11

                            old_point(23) = 10**(old_point(23))   ! sigma_int_R11

                            old_point(24) = 10**(old_point(24))   ! sigma_int_R11

                            old_point(25) = 10**(old_point(25))   ! sigma_int_R11

                            old_point(26) = 10**(old_point(26))   ! sigma_int_R11

                            old_loglikelihood = log_R11_likelihood_W_LMC_sigma_int(old_point(1:number_model_parameters-16),&
                                 old_point(number_model_parameters-15),old_point(number_model_parameters-14),&
                                 old_point(number_model_parameters-13),old_point(number_model_parameters-12),&
                            ...
                            old_point(17) = log10(old_point(17))   ! log10(sigma_int_LMC)

                            old_point(18) = log10(old_point(18))   ! log10(sigma_int_R11)

                            old_point(19) = log10(old_point(19))   ! log10(sigma_int_R11)

                            old_point(20) = log10(old_point(20))   ! log10(sigma_int_R11)

                            old_point(21) = log10(old_point(21))   ! log10(sigma_int_R11)

                            old_point(22) = log10(old_point(22))   ! log10(sigma_int_R11)

                            old_point(23) = log10(old_point(23))   ! log10(sigma_int_R11)

                            old_point(24) = log10(old_point(24))   ! log10(sigma_int_R11)

                            old_point(25) = log10(old_point(25))   ! log10(sigma_int_R11)

                            old_point(26) = log10(old_point(26))   ! log10(sigma_int_R11)
                         ...
                         Else
                            ...
                            If (varying_sigma_int) then
                               ...
                               old_loglikelihood = log_R11_likelihood_W_LMC(old_point(1:number_model_parameters-8),&
                ...
                If (use_metallicity) then 
                   ...
                   Else
                      ...
                      If (sigma_int_per_R11_host) then
                         ...
                         plausibility(17) =  (x_new(17) .lt. real(-3.d0)) .or. (x_new(17) .gt. real(-0.7d0))    ! limit log10(sigma_int_LMC)

                         plausibility(18) =  (x_new(18) .lt. real(-3.d0)) .or. (x_new(18) .gt. real(-0.7d0))    ! limit log10(sigma_int_R11)

                         plausibility(19) =  (x_new(19) .lt. real(-3.d0)) .or. (x_new(19) .gt. real(-0.7d0))    ! limit log10(sigma_int_R11)

                         plausibility(20) =  (x_new(20) .lt. real(-3.d0)) .or. (x_new(20) .gt. real(-0.7d0))    ! limit log10(sigma_int_R11)

                         plausibility(21) =  (x_new(21) .lt. real(-3.d0)) .or. (x_new(21) .gt. real(-0.7d0))    ! limit log10(sigma_int_R11)

                         plausibility(22) =  (x_new(22) .lt. real(-3.d0)) .or. (x_new(22) .gt. real(-0.7d0))    ! limit log10(sigma_int_R11)

                         plausibility(23) =  (x_new(23) .lt. real(-3.d0)) .or. (x_new(23) .gt. real(-0.7d0))    ! limit log10(sigma_int_R11)

                         plausibility(24) =  (x_new(24) .lt. real(-3.d0)) .or. (x_new(24) .gt. real(-0.7d0))    ! limit log10(sigma_int_R11)

                         plausibility(25) =  (x_new(25) .lt. real(-3.d0)) .or. (x_new(25) .gt. real(-0.7d0))    ! limit log10(sigma_int_R11)

                         plausibility(26) =  (x_new(26) .lt. real(-3.d0)) .or. (x_new(26) .gt. real(-0.7d0))    ! limit log10(sigma_int_R11)
                      ...
                      Else
                         ...
                         Else
                            ...
                            print *, 'MUST IMPLEMENTE NO VARYING SIGMA INT'
                         ...
                         If (use_metallicity) then 
                            ...
                            Else
                               ...
                               If (sigma_int_per_R11_host) then
                                  ...
                                  current_point(17) = 10**(current_point(17)) ! sigma_int_LMC

                                  current_point(18) = 10**(current_point(18)) ! sigma_int_R11

                                  current_point(19) = 10**(current_point(19)) ! sigma_int_R11

                                  current_point(20) = 10**(current_point(20)) ! sigma_int_R11

                                  current_point(21) = 10**(current_point(21)) ! sigma_int_R11

                                  current_point(22) = 10**(current_point(22)) ! sigma_int_R11

                                  current_point(23) = 10**(current_point(23)) ! sigma_int_R11

                                  current_point(24) = 10**(current_point(24)) ! sigma_int_R11

                                  current_point(25) = 10**(current_point(25)) ! sigma_int_R11

                                  current_point(26) = 10**(current_point(26)) ! sigma_int_R11

                                  current_loglikelihood = log_R11_likelihood_W_LMC_sigma_int(&
                                       current_point(1:number_model_parameters-16),&
                                       current_point(number_model_parameters-15),current_point(number_model_parameters-14),&
                                       current_point(number_model_parameters-13),current_point(number_model_parameters-12),&
                                  ...
                                  current_point(17) = log10(current_point(17)) ! log10(sigma_int_LMC)

                                  current_point(18) = log10(current_point(18)) ! log10(sigma_int_R11)

                                  current_point(19) = log10(current_point(19)) ! log10(sigma_int_R11)

                                  current_point(20) = log10(current_point(20)) ! log10(sigma_int_R11)

                                  current_point(21) = log10(current_point(21)) ! log10(sigma_int_R11)

                                  current_point(22) = log10(current_point(22)) ! log10(sigma_int_R11)

                                  current_point(23) = log10(current_point(23)) ! log10(sigma_int_R11)

                                  current_point(24) = log10(current_point(24)) ! log10(sigma_int_R11)

                                  current_point(25) = log10(current_point(25)) ! log10(sigma_int_R11)

                                  current_point(26) = log10(current_point(26)) ! log10(sigma_int_R11)
                               ...
                               Else
                                  ...
                                  If (varying_sigma_int) then
                                     ...
                                     current_loglikelihood = log_R11_likelihood_W_LMC(current_point(1:number_model_parameters-8),&
                                  ...
                                  Else
                                     ...
                                     print *,'NO VARYING SIGMA INT IMPLEMENTED'
