                   ...
                   If (use_metallicity) then 
                      ...
                      Else
                         ...
                         If (sigma_int_per_R11_host)  then
                            ...
                            old_point(27) = log10(prior_sigma_int_LMC)
                   ...
                   If (use_metallicity) then 
                      ...
                      Else
                         ...
                         If (sigma_int_per_R11_host) then
                            ...
                            old_loglikelihood = log_R11_likelihood_W_MW_NGC4258_sigma_int(old_point(1:number_model_parameters-17),&
                   ...
                   Else
                      ...
                      Else
                         ...
                         If (varying_sigma_int) then
                            ...
                            print *, 'NEED TO ADD LMC PARAMETERS'
                   ...
                   Else
                      ...
                      Else
                         ...
                         If (varying_sigma_int) then
                            ...
                            write(UNIT_RANGES_FILE,*) ''//trim(paramnames(10))//'   -7.    1.'
                   ...
                   Else
                      ...
                      Else
                         ...
                         If (varying_sigma_int) then
                            ...
                            plausibility(10) = (x_new(10) .le. real(-7.d0)) .or. (x_new(10) .ge. real(1.d0))
                         ...
                         If (use_metallicity) then 
                            ...
                            Else
                               ...
                               If (sigma_int_per_R11_host) then
                                  ...
                                  current_loglikelihood = log_R11_likelihood_W_MW_NGC4258_sigma_int(&
                               ...
                               Else
                                  ...
                                  If (varying_sigma_int) then
                                     ...
                                     current_loglikelihood = log_R11_likelihood_W_MW_NGC4258(&
                                          current_point(1:number_model_parameters-8),&
              ...
              Else If ( ( use_NGC4258_as_anchor .and. .not.use_LMC_as_anchor ) .and. use_MW_as_anchor ) then
                 ...
                 Do m=1,size(FieldHipp)
                    ...
                    If (10**(logP(m)) .lt. cepheid_Period_limit) then
                       ...
                       If ( chi2R11_W_MW(bestfit(11),bestfit(12),bestfit(14),10**(bestfit(17)),m)&
                            .le. 1.d0 ) then
