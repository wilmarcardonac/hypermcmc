                   ...
                   If (use_metallicity) then 
                      ...
                      Else
                         ...
                         If (sigma_int_per_R11_host) then
                            ...
                            old_loglikelihood = log_R11_likelihood_W_LMC_NGC4258_sigma_int(old_point(1:number_model_parameters-16),&
                         ...
                         If (use_metallicity) then 
                            ...
                            Else
                               ...
                               If (sigma_int_per_R11_host) then
                                  ...
                                  current_loglikelihood = log_R11_likelihood_W_LMC_NGC4258_sigma_int(&
                               ...
                               Else
                                  ...
                                  If (varying_sigma_int) then
                                     ...
                                     current_loglikelihood = log_R11_likelihood_W_LMC_NGC4258(&
